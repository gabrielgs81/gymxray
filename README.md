...
```sh
git clone https://github.com/gabrielgs81/gymxray.git
cd gymxray
npm install
npm run dev
```
...
Importe o repositório na Vercel e mantenha as configurações detectadas automaticamente. O build
usa Nitro com o preset da Vercel e não depende de serviços externos para executar o quiz.
